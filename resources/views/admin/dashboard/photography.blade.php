                            ...
                            <tbody class="table-border-bottom-0">
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user['email'] }}</td>
                                        <td>
                                            <a href="{{ $user['submission'] == null ? "#" : asset('Photography/'.$user['submission']) }}" target="_blank">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 1200px; width:100%; margin:auto; padding:5%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.photography') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="row mb-3">
