...
>
    <head>
        ...
        <link
            rel="icon"
            type="image/x-icon"
            href="{{ asset("assets/img/sifest2022/logo_sifest.png") }}"
        />
        ...
        <link
            rel="stylesheet"
            href="{{ asset("admin/vendor/css/theme-default.css") }}"
        ...
        <link
            rel="stylesheet"
            href="{{ asset("vendor/datatables/datatables.min.js") }}"
        />
                                ...
                                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                    ...
                                    >
                                        <div class="avatar avatar-online">
                                            <img
                                                src="{{ asset("admin/img/avatars/1.png") }}"
                                                alt
