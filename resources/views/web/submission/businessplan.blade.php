    ...
    <div class="wrapper">
        ...
        <div class="container p_relative py20">
            <div class="title_font text_center mt20 mb12">
                ...
                <p class="fc_red">Business Plan Competicion</p>
            </div>
            <div class="form_wrapper box_lt_rb_side p6">
                <i class="box_lt_rb_side_design"></i>
                <form action="{{ route("submission.business.plan") }}" method="post" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="input_wrapper">
                                ...
                                <div class="error_msg">
                                    <p class="text_xsm fc_red">
                                        ...
                                        <b>BPCSIFEST_Nama Tim_Judul Bisnis</b>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    @if ($user['submission'])
                        ...
                        <a href="{{ asset('BusinessPlan/'.$user['submission']) }}" class="fw_bold fc_red" target="_blank" style="text-decoration: underline !important">{{ $user['submission'] }}</a>
                    @endif
                </form>
            </div>
        </div>
